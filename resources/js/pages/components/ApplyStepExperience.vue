...
<div class=" w-full">
      <h2 class="text-xl font-bold mb-4">Votre plus récente expérience</h2>
        <div class="w-full mb-2 border-b border-b-gray-300 py-3" v-for="(refItem, indexRef) in form.experiences" :key="indexRef">
              ...
              <button v-if="indexRef>0 && !form.experiences[indexRef]?.uuid" type="button" @click="() => removeReference(indexRef)" 
