...
// Mapping des statuts vers des classes de style
const getStatusClasses = (status: string) => {
  switch (status) {
    case '0_handled_by_hosted_center':
      return 'bg-gray-100 text-gray-700';
    case '1_recruitment_form_validation':
      return 'bg-blue-100 text-blue-700';
    case '2_job_announcement_process':
    case '2a_translation_ongoing':
    case '2b_translation_received':
    case '2c_advertising':
    case '2d_selection_criteria_request':
    case '2e_selection_criteria_transmission':
      return 'bg-yellow-100 text-yellow-700';
    case '3_longlist_process':
    case '3a_application_downloading':
    case '3b_longlist_matrix':
      return 'bg-indigo-100 text-indigo-700';
    case '4_shortlist_process':
    case '4a_shortlist_matrix_ongoing':
    case '4b_shortlist_matrix_consolidation':
    case '4c_shortlist_matrix_approval':
      return 'bg-purple-100 text-purple-700';
    case '5_interview_process':
    case '5a_interview_date_plan':
    case '5b_rating_sheet_transmission':
      return 'bg-teal-100 text-teal-700';
    case '6_recruitment_report':
    case '6a_report_to_send':
    case '6b_report_sent':
    case '6c_report_signature_process':
    case '6d_report_approved_process':
      return 'bg-orange-100 text-orange-700';
    case '7_offer_process':
    case '7a_offer_drafted':
    case '7b_offer_sent':
    case '7c_offer_negotiation':
    case '7d_offer_accepted':
    case '7e_offer_rejected':
      return 'bg-green-100 text-green-700';
    case '8_reference_check':
    case '8a_reference_details_acknowledge':
    case '8b_emails_to_send':
    case '8c_references_to_receive':
      return 'bg-pink-100 text-pink-700';
    case '9_contract_drafting':
    case '9a_tors_signature':
    case '9b_contract_to_send':
    case '9c_contract_sent':
    case '9d_countersigned_contract_to_send':
    case '9e_process_finalized':
...
// Nouvelle liste des statuts avec labels
const statusList = [
...
// Récupère le label à partir du status
