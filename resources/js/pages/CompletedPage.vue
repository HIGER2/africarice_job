...
const { fields, form, payLoad,documentPreview, currentStep, handleFile, components, nextStep, prevStep, submitCompleted } = useApplyForm()
      ...
      <!-- <div class="bg-white  border border-gray-200 rounded-lg p-5 mb-6">
        ...
        <div>
          ...
          <h3 class="text-xl font-semibold text-gray-800 mb-4 text-center">
            Complétez vos informations<br />
            <span class="text-gray-500 text-base">Complete your information</span>
          </h3>
